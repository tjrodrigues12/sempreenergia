...
class SlideDeckCovers {
    ...
    function get( $slidedeck_id ) {
        ...
        $cover = wp_cache_get( $cache_key, slidedeck_cache_group( 'cover-get' ) );
        ...
        if( $cover == false ) {
            ...
            wp_cache_set( $cache_key, $cover, slidedeck_cache_group( 'cover-get' ) );
        }
    ...
    function get_defaults( $slidedeck_id = null ) {
        ...
        if( isset( $slidedeck_id ) ) {
            ...
            if( !empty( $slidedeck ) ) {
                ...
                if( isset( $slidedeck['options']['titleFont'] ) && !empty( $slidedeck['options']['titleFont'] ) ) {
                    $defaults['title_font'] = $slidedeck['options']['titleFont'];
                } else {
                    $defaults['title_font'] = $slidedeck['options']['ctaBtnTextFont'];
                }
            }
        }
    ...
    function render( $slidedeck_id, $front_back = 'front' ) {
        ...
        ob_start();
            ...
            include( SLIDEDECK_DIRNAME . '/views/elements/_' . $front_back . '-cover.php' );
