...
//		}
		...
		static function sd_fs() {
            ...
            if ( ! isset( $sd_fs ) ) {
                ...
                $sd_fs = ras_dynamic_init(
                    array(
                        'id'              => '15',
                        'slug'            => 'slidedeck',
                        'product_name'    => 'SlideDeck',
                        'module_type'     => 'plugin',
                        'version'         => '5.3.8',
                        'plugin_basename' => 'slidedeck/slidedeck.php',
                        'plugin_url'      => SLIDEDECK_URL,
                    )
                );
            }
		...
		function print_javascript_constants() {
			if ( ! isset( $this->constants_printed ) ) {
				...
				if ( is_admin() ) {
					echo 'var slideDeck2AddonsURL = "' . slidedeck_action( '/upgrades' ) . '";' . "\n";
				}
