...
function EWD_US_Add_Modified_Styles() {
	...
	$StylesString .=".ewd-slide .slideTitle { ";
		...
		if (get_option("EWD_us_Slide_Title_Font_Size") != "") {$StylesString .= "font-size:" .  EWD_US_Check_Font_Size(get_option("EWD_us_Slide_Title_Font_Size")) . " !important;";}
	...
	$StylesString .=".ewd-slide .slideExcerpt { ";
		...
		if (get_option("EWD_us_Slide_Text_Font_Size") != "") {$StylesString .= "font-size:" .  EWD_US_Check_Font_Size(get_option("EWD_us_Slide_Text_Font_Size")) . " !important;";}
	...
	$StylesString .=".ewd-slide .slideButtons li a { ";
		...
		if (get_option("EWD_us_Button_Font_Size") != "") {$StylesString .= "font-size:" .  EWD_US_Check_Font_Size(get_option("EWD_us_Button_Font_Size")) . " !important;";}
	...
	$StylesString .=".slider .nav-arrow .ewd-slider-icon { ";
		...
		if (get_option("EWD_us_Arrow_Font_Size") != "") {$StylesString .= "font-size:" . EWD_US_Check_Font_Size(get_option("EWD_us_Arrow_Font_Size")) . " !important;";}
...
function EWD_US_Check_Font_Size($Font_Size) {
